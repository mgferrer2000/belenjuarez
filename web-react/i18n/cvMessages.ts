...
const FR_SCIENTIFIC_TEXTS: Record<string, string> = {
    ...
    'Actualmente imparte docencia en el Grado en Farmacia y en dos Másteres oficiales de postgrado de la UGR, con más de 2.500 horas impartidas. Tiene reconocidos 5 quinquenios docentes, 3 sexenios de investigación CNEAI, con último sexenio reconocido en el periodo 2015-2020, y 5 tramos autonómicos reconocidos en 2019.': 'Elle enseigne actuellement dans le diplôme de pharmacie et dans deux masters officiels de troisième cycle de l’UGR, pour un total de plus de 2 500 heures d’enseignement. Elle compte 5 quinquennats d’enseignement reconnus, 3 périodes de recherche CNEAI, dont la dernière reconnue pour 2015-2020, et 5 évaluations régionales reconnues en 2019.',
